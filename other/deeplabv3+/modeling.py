...
# Deeplab v3
def deeplabv3_hrnetv2_48(num_classes=2, output_stride=8, pretrained_backbone=False): # no pretrained backbone yet
    return _load_model('deeplabv3', 'hrnetv2_48', output_stride, num_classes, pretrained_backbone=pretrained_backbone)

def deeplabv3_hrnetv2_32(num_classes=2, output_stride=8, pretrained_backbone=True):
...
def deeplabv3_mobilenet(num_classes=2, output_stride=8, pretrained_backbone=True, **kwargs):
...
def deeplabv3_xception(num_classes=2, output_stride=8, pretrained_backbone=True, **kwargs):
...
# Deeplab v3+
def deeplabv3plus_hrnetv2_48(num_classes=2, output_stride=8, pretrained_backbone=False): # no pretrained backbone yet
    return _load_model('deeplabv3plus', 'hrnetv2_48', num_classes, output_stride, pretrained_backbone=pretrained_backbone)

def deeplabv3plus_hrnetv2_32(num_classes=2, output_stride=8, pretrained_backbone=True):
    return _load_model('deeplabv3plus', 'hrnetv2_32', num_classes, output_stride, pretrained_backbone=pretrained_backbone)

def deeplabv3plus_resnet50(num_classes=2, output_stride=8, pretrained_backbone=True):
    """Constructs a DeepLabV3 model with a ResNet-50 backbone.
...
def deeplabv3plus_resnet101(num_classes=2, output_stride=8, pretrained_backbone=True):
    """Constructs a DeepLabV3+ model with a ResNet-101 backbone.
...
def deeplabv3plus_mobilenet(num_classes=2, output_stride=8, pretrained_backbone=True):
    """Constructs a DeepLabV3+ model with a MobileNetv2 backbone.
...
def deeplabv3plus_xception(num_classes=2, output_stride=8, pretrained_backbone=True):
    """Constructs a DeepLabV3+ model with a Xception backbone.
