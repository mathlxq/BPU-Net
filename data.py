...
from segmentation.weight_map_loss1 import caculate_weight_map
...
class IronDataset(Dataset):
    ...
    def __init__(self, dataset_folder, train=True, transform=None, crop = True, crop_size=(400, 400), dilate = 5):
        ...
        if self.train:
            folder =  "/home/user/dongruixuan/datasets/segmentation/net_train/train/"
        else:
            folder ="/home/user/dongruixuan/datasets/segmentation/net_train/val_crop/"
