...
from segmentation.model import AttU_Net
...
class Trainer(object):
    ...
    def __init__(self, bs=12, loss_type='CE', data_dir = ''):
        # parameteres
        self.batch_size = bs
        ...
        self.model = AttU_Net(img_ch=1,output_ch=2)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='AttU-Net training')
    ...
    st_time = time.time()
    # model save address
    checkpoint_path = '/home/user/dongruixuan /iron/ATTENTION/Att-ce/segmentation/parameter/AttU_Net_model/'
